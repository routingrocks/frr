				  ...
				  const char *reason)
{
	...
	frrtrace(6, frr_bgp, ug_subgroup_merge,
		 subgrp->update_group ? subgrp->update_group->id : 0, subgrp->id, peer_count,
		 target->update_group ? target->update_group->id : 0, target->id,
