...
/* new structure for unreachability */
...
/* Route generated by conditional disaggregation - should not be suppressed by aggregates */
#define BGP_PATH_CONDITIONAL_DISAGG (1 << 22)
