...
static struct log_ref ferr_bgp_warn[] = {
	...
	},
	{
		...
		.description = "BGP has received a non-zero value in a reserved field that was used for "
		"SNPA-length at one point in time",
		.suggestion = "BGP has peered with either a router that is attempting to send SNPA data or it "
		"has received a corrupted packet. If we are peering with a SNPA aware "
		"router(unlikely) upgrade that router, else open an Issue after gathering "
		"relevant log files",
	},
	{
		.code = EC_BGP_MISSING_ATTRIBUTE,
		.title = "BGP has received an update with missing a missing attribute",
		.description = "BGP received update packets must have some minimum attribute information "
		"within them",
	...
	},
	{
		...
		.description = "BGP has received an update packet that is too small to parse a given "
		"attribute. This typically means that something has gone wrong between us and "
		"the remote peer",
		.suggestion = "Gather log data from this and remote peer and open an Issue with this data",
	},
	{
		.code = EC_BGP_EXT_ATTRIBUTE_TOO_SMALL,
		.title = "BGP udate packet with extended attribute data that is too "
		"small",
		.description = "BGP has received an update packet that is too small to parse a given extended "
		"attribute. This typically means that something has gone wrong between us and "
		"the remote peer",
		.suggestion = "Gather log data from this and remote peer and open an Issue with this data",
	},
	{
		...
		.description = "BGP has received an update packet with a attribute that is repeated more than "
		"one time for a particular route. This typically means that something has gone "
		"wrong between us and the remote peer",
		.suggestion = "Gather log data from this and remote peer and open an Issue with this data",
	},
	{
		.code = EC_BGP_ATTRIBUTE_TOO_LARGE,
		.title = "BGP udate packet with attribute data that is too large",
		.description = "BGP has received an update packet that has too much data in a particular "
		"attribute. This typically means that something has gone wrong between us and "
		"the remote peer",
		.suggestion = "Gather log data from this and remote peer and open an Issue with this data",
	},
	{
		...
		.title = "BGP update packet with attribute data has a parse error, "
		"specific to the attribute",
		.description = "BGP has received an update packet with an attribute that when parsed does not "
		"make sense in some manner",
		.suggestion = "Gather log data from this and remote peer and open an Issue with this data",
	},
	{
		.code = EC_BGP_ATTRIBUTE_PARSE_WITHDRAW,
		.title = "BGP update packet with a broken optional attribute has caused "
		"a withdraw of associated routes",
		.description = "BGP has received a update packet with optional attributes that did not parse "
		"correctly, instead of resetting the peer, withdraw associated routes and note "
	...
	},
	{
		...
		.title = "BGP update packet with a length different than attribute data "
		"length",
		.description = "BGP has received a update packet with attributes that when parsed do not "
		"correctly add up to packet data length",
		.suggestion = "Gather log data from this and remote peer and open an Issue with this data",
	},
	{
		.code = EC_BGP_DUMP,
	...
	},
	{
		...
		.suggestion = "Determine the source of the update packet and examine that peer for what has "
		"gone wrong",
	},
	{
	...
	},
	{
		...
		.description = "The negotiation of capabilities has received a capability that we do not know "
		"what to do with",
		.suggestion = "Determine the source of the capability and remove the capability from what is "
		"sent",
	},
	{
		.code = EC_BGP_NO_TCP_MD5,
		.title = "Unable to set TCP MD5 option on socket",
		.description = "BGP attempted to setup TCP MD5 configuration on the socket as per "
		"configuration but was unable to",
	...
	},
	{
		...
		.description = "BGP has received a type-3 NLRI with PMSI information. At this time FRR is not "
		"capable of properly handling this NLRI type",
	...
	},
	{
		...
		.description = "BGP has received a local macip from zebra and has no way to properly handle "
		"the macip because the vni is not setup properly",
		.suggestion = "Ensure proper setup of BGP EVPN",
	},
	{
		.code = EC_BGP_EVPN_ESI,
		.title = "BGP has received a local ESI for deletion",
		.description = "BGP has received a local ESI for deletion but when attempting to find the "
		"stored data internally was unable to find the information for deletion",
		.suggestion = "Gather logging and open an Issue",
	},
	{
		.code = EC_BGP_INVALID_LABEL_STACK,
		.title = "BGP has received a label stack in a NLRI that does not have "
		"the BOS marked",
		.description = "BGP when it receives a NLRI with a label stack should have the BOS marked, "
		"this received packet does not have this",
		.suggestion = "Gather log information from here and remote peer and open an Issue",
	},
	{
		.code = EC_BGP_ZEBRA_SEND,
		.title = "BGP has attempted to send data to zebra and has failed to do "
		"so",
	...
	},
	{
		...
		.title = "BGP capability length or structure invalid",
		.description = "BGP received a capability with incorrect length field or malformed structure",
		.suggestion = "Review peer configuration and firmware version. Verify capability parameters. "
		"If configuration is correct, gather log files and open an issue.",
	},
	{
		.code = EC_BGP_CAPABILITY_INVALID_DATA,
		.title = "BGP has received capability data with invalid information",
		.description = "BGP has noticed that during processing of capability information that data was "
		"wrong",
		.suggestion = "Check peer capability configuration and action values. Verify BGP version "
		"compatibility. If configuration is correct, gather log files and open an "
		"issue.",
	},
	{
		.code = EC_BGP_CAPABILITY_VENDOR,
		.title = "BGP has received capability data specific to a particular "
		"vendor",
		.description = "BGP has received a capability that is vendor specific and as such we have no "
		"knowledge of how to use this capability in FRR",
	...
	},
	{
		...
		.description = "BGP has received a capability that it does not know how to decode. This may be "
		"due to a new feature that has not been coded into FRR or it may be a bug in "
		"the remote peer",
	...
	},
	{
		...
		.description = "BGP is in the process of building NLRI information for a peer and has "
		"discovered an inconsistent internal state",
		.suggestion = "Gather log files and open an Issue, restart FRR",
	},
	{
		.code = EC_BGP_SENDQ_STUCK_WARN,
		.title = "BGP has been unable to send anything to a peer for an "
		"extended time",
		.description = "The BGP peer does not seem to be receiving or processing any data received "
		"from us, causing updates to be delayed.",
...
static struct log_ref ferr_bgp_err[] = {
	{
		...
		.suggestion = "Determine the source of the attribute and determine why the attribute flag has "
	...
	},
	{
		...
		.suggestion = "Determine the source of the attribute and determine why the attribute length "
	...
	},
	{
		...
		.suggestion = "Determine the source of the attribute and determine why the origin attribute "
		"has been set incorrectly",
	},
	{
		...
		.suggestion = "Determine the source of the update and determine why the as path has been set "
		"incorrectly",
	},
	{
		...
		.suggestion = "Determine the source of the update and determine why the as path first as "
		"value has been set incorrectly",
	},
	{
		...
		.suggestion = "Determine the source of the update and determine why the PMSI tunnel attribute "
		"type has been set incorrectly",
	},
	{
	...
	},
	{
		...
		.suggestion = "Determine the source of the attribute and determine why the AIGP attribute has "
		"been set incorrectly",
	},
	{
	...
	},
	{
		...
		.suggestion = "Determine if all expected peers are removed and restart FRR if not. Most "
		"likely a bug",
	},
	{
	...
	},
	{
		...
		.description = "BGP attempted to generate JSON output and was unable to allocate the memory "
		"required",
	...
	},
	{
		...
		.suggestion = "Most likely a bug. If the problem persists, report the problem for "
		"troubleshooting",
	},
	{
	...
	},
	{
		...
		.description = "BGP failed to send data to peer (open response, capability information, or "
		"other protocol messages)",
		.suggestion = "Check peer connectivity and local IP address configuration. Verify peer state "
	...
	},
	{
		...
		.suggestion = "BGP notify received while in stopped state. If the problem persists, report "
		"for troubleshooting",
	},
	{
		...
		.suggestion = "BGP keepalive received while in stopped state. If the problem persists, report "
		"for troubleshooting",
	},
	{
	...
	},
	{
		...
		.suggestion = "BGP received nexthop update but nexthop is not reachable in this bgp instance. "
		"Report for troubleshooting",
	},
	{
		.code = EC_BGP_LABEL,
	...
	},
	{
		...
		.suggestion = "Correct configuration or addressing so that same not learned both local and "
		"remote",
	},
	{
	...
	},
	{
		...
		.suggestion = "Determine the source of the EVPN route and resolve whatever is causing invalid "
		"contents",
	},
	{
	...
	},
	{
		...
		.suggestion = "Correct the configuration so that the BGP AS number and instance name are "
		"consistent",
	},
	{
		.code = EC_BGP_FLOWSPEC_PACKET,
		.title = "BGP Flowspec packet processing error",
		.description = "The BGP flowspec subsystem has detected a error in the send or receive of a "
		"packet",
	...
	},
	{
		...
		.description = "The BGP flowspec subsystem has detected that there was a failure for "
		"installation/removal/modification of Flowspec from the dataplane",
		.suggestion = "Gather log files from the router and open an issue, Restart FRR",
	},
	{
		.code = EC_BGP_DOPPELGANGER_CONFIG,
		.title = "BGP has detected a configuration overwrite during peer "
		"collision resolution",
		.description = "As part of BGP startup, the peer and ourselves can start connections to each "
		"other at the same time. During this process BGP received additional "
		"configuration, but it was only applied to one of the two nascent connections. "
		"Depending on the result of collision detection and resolution this "
		"configuration might be lost. To remedy this, after performing collision "
		"detection and resolution the peer session has been reset in order to apply the "
		"new configuration.",
		.suggestion = "Gather data and open a Issue so that this developmental escape can be fixed, "
		"the peer should have been reset",
	},
	{
		.code = EC_BGP_ROUTER_ID_SAME,
		.title = "BGP has detected a duplicate router id during collision "
		"resolution",
		.description = "As part of normal collision detection for opening a connection to a peer, BGP "
		"has detected that the remote peer's router-id is the same as ours",
		.suggestion = "Change one of the two router-id's",
	},
	{
		.code = EC_BGP_INVALID_BGP_INSTANCE,
		.title = "BGP instance is invalid or unavailable",
		.description = "BGP instance is NULL or cannot be retrieved for the specified VRF/context",
		.suggestion = "Verify BGP instance configuration and VRF setup. If configuration is correct, "
		"gather log files and open an issue.",
	},
	{
	...
	},
	{
		...
		.description = "BGP when using a v6 peer requires a v6 LL address to be configured on the "
		"outgoing interface as per RFC 4291 section 2.1",
		.suggestion = "Add a v6 LL address to the outgoing interfaces as per RFC",
	},
	{
		.code = EC_BGP_SENDQ_STUCK_PROPER,
		.title = "BGP is shutting down a peer due to being unable to send "
		"anything for an extended time",
		.description = "No BGP updates were successfully sent to the peer for more than twice the "
		"holdtime.",
		.suggestion = "Check connectivity to the peer and that it is not overloaded",
	},
	{
		...
		.suggestion = "Correct the configuration to avoid overlapping IPs in vrf having route leak "
		"configured",
	},
	{
		.code = EC_BGP_ROUTE_REFRESH_INVALID,
		.title = "BGP route refresh message format error",
		.description = "BGP received an invalid or malformed route refresh message from peer (enhanced "
		"route refresh length error, invalid subtype, or EoRR without BoRR)",
		.suggestion = "Check BGP capability compatibility with peer. Verify enhanced route refresh "
		"configuration and ensure proper BoRR/EoRR sequence.",
	},
	{
		...
		.suggestion = "Ensure the nexthop group and advertised paths include IPv6 information. Verify "
		"per-source nexthop group configuration.",
	},
	{
		.code = EC_BGP_ROUTE_ATTRIBUTE_MALFORMED,
		.title = "BGP route attribute is malformed or invalid",
		.description = "BGP received or processed a route with malformed attributes (prefix, RD, ESI, "
		"MAC, gateway IP, L2VPN prefix data, address family mismatches, "
		"route-map/label-index mismatches) or referenced route not found",
		.suggestion = "Check route definitions and EVPN/L2VPN configuration. Verify peer "
		"configuration for attribute consistency, address family matching, and static "
		"route configuration alignment. Ensure all referenced routes exist and route "
		"data format is correct.",
	},
	{
		.code = EC_BGP_CONFIG_CONSTRAINT_VIOLATION,
		.title = "BGP configuration constraint violated",
		.description = "BGP configuration attempted to change an immutable parameter (e.g., "
		"label-index)",
		.suggestion = "Review configuration changes to ensure immutable parameters are not modified "
		"after initial setup.",
	},
	{
		...
		.suggestion = "Debug the route-map script and ensure it returns successful status. Verify "
		"script accessibility and correct any errors in the script file.",
	},
	{
	...
	},
	{
		...
		.suggestion = "Ensure BGP and Zebra daemons are version-synchronized and IPC communication is "
		"healthy. Check for version mismatches between daemons.",
	},
	{
		.code = EC_BGP_SRV6_LOCATOR_MISMATCH,
		.title = "BGP SRv6 locator name mismatch",
		.description = "BGP SRv6 locator advertised by BGP doesn't match the locator name in the SRv6 "
		"chunk from Zebra",
	...
	},
	{
		...
		.suggestion = "Choose one SRv6 SID mode (typically auto), remove the other from the config, "
		"and reapply the import/export settings.",
	},
	{
	...
	},
	{
		...
		.description = "BGP failed to configure TTL security parameters (min/max TTL) on peer "
		"connection",
		.suggestion = "Ensure both peers support TTL security feature and verify kernel supports TTL "
		"security socket options. Check peer TTL security configuration for "
		"compatibility.",
	},
	{
		.code = END_FERR,
