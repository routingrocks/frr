...
def print_prefix_addr(field_val):
    """
    pretty print "struct prefix" - address only (for backwards compatibility)
    """
...
def print_prefix_with_len(field_val):
    """
    pretty print "struct prefix" with prefix length (e.g., 2001:1:1:1::/127)
    struct prefix layout: [0]=family, [1]=padding, [2]=prefixlen, [8:24]=address
    Note: prefixlen is at offset 2 due to struct alignment
    """
...
def parse_frr_bfd_echo_mode_change(event):
    ...
    field_parsers = {
        "echo_enabled": lambda x: "ENABLED" if x else "DISABLED"
    }
    parse_event(event, field_parsers)
...
def parse_frr_bfd_control_client_event(event):
    ...
    field_parsers = {
        "is_connect": lambda x: "CONNECT" if x else "DISCONNECT"
    }
    parse_event(event, field_parsers)
...
def parse_frr_bfd_dplane_session_update(event):
    ...
    field_parsers = {
        "is_add": lambda x: "ADD" if x else "DELETE"
    }
    parse_event(event, field_parsers)
...
def parse_frr_bfd_dplane_echo(event):
    ...
    field_parsers = {
        "is_request": lambda x: "REQUEST" if x else "REPLY"
    }
    parse_event(event, field_parsers)
...
def print_reporter_id(field_val):
    """
    pretty print reporter ID (struct in_addr as 4 bytes)
    """
...
def print_unreach_timestamp(field_val):
    """
    pretty print unreachability timestamp (epoch seconds to local time)
    Matches the format used by the main trace event timestamp
    """
    if field_val:
        return datetime.datetime.fromtimestamp(field_val).strftime('%Y-%m-%dT%H:%M:%S')
    return "0"


def print_unreach_intent(field_val):
    """
    pretty print unreach zebra_announce intent (1=INJECT, 0=WITHDRAW_IF_SENT)
    INJECT = announce unreachability (prefix is unreachable)
    WITHDRAW_IF_SENT = cancel previously announced unreachability (if any was sent)
    """
    return "INJECT" if field_val else "WITHDRAW_IF_SENT"


def print_unreach_info_oper(field_val):
    """
    pretty print unreach_info_add oper (1=ADD, 0=UPD)
    """
    return "ADD" if field_val else "UPD"


def print_up_down(field_val):
    """
    pretty print interface oper/admin state (1=UP, 0=DOWN)
    """
    return "UP" if field_val else "DOWN"
...
def parse_frr_bgp_unreach_zebra_announce(event):
    field_parsers = {
        "prefix": print_prefix_with_len,
        "oper": print_up_down,
        "admin": print_up_down,
        "intent": print_unreach_intent
    }
    parse_event(event, field_parsers)
...
def parse_frr_bgp_unreach_filter_add(event):
    field_parsers = {
        "filter_prefix": print_prefix_with_len
    }
    parse_event(event, field_parsers)


def parse_frr_bgp_unreach_filter_remove(event):
    field_parsers = {}
    parse_event(event, field_parsers)
...
def main():
    ...
    event_parsers = {"frr_bgp:evpn_mac_ip_zsend":
                     ...
                     parse_frr_bgp_unreach_info_delete,
                     "frr_bgp:unreach_zebra_announce":
                     parse_frr_bgp_unreach_zebra_announce,
                     "frr_bgp:unreach_nlri_received":
                     parse_frr_bgp_unreach_nlri_received,
                     "frr_bgp:unreach_nlri_withdraw_received":
                     parse_frr_bgp_unreach_nlri_withdraw_received,
                     "frr_bgp:unreach_vty_inject":
                     parse_frr_bgp_unreach_vty_inject,
                     "frr_bgp:unreach_vty_delete":
                     parse_frr_bgp_unreach_vty_delete,
                     "frr_bgp:unreach_filter_add":
                     parse_frr_bgp_unreach_filter_add,
                     "frr_bgp:unreach_filter_remove":
                     parse_frr_bgp_unreach_filter_remove,
                     "frr_bgp:unreach_tlv_parse_error":
                     ...
                     parse_frr_bfd_packet_validation_error,
                     "frr_bfd:dplane_init_error":
                     parse_frr_bfd_dplane_init_error,
                     "frr_bfd:auth_event":
                     parse_frr_bfd_auth_event,
                     "frr_bfd:state_change":
                     parse_frr_bfd_state_change,
                     "frr_bfd:session_enable_event":
                     parse_frr_bfd_session_enable_event,
                     "frr_bfd:control_notify":
                     parse_frr_bfd_control_notify,
                     "frr_bfd:remote_discriminator_change":
                     parse_frr_bfd_remote_discriminator_change,
                     "frr_bfd:session_lifecycle":
                     parse_frr_bfd_session_lifecycle,
                     "frr_bfd:packet_session_not_found":
                     parse_frr_bfd_packet_session_not_found,
                     "frr_bfd:packet_remote_discr_zero":
                     parse_frr_bfd_packet_remote_discr_zero,
                     "frr_bfd:packet_ttl_exceeded":
                     parse_frr_bfd_packet_ttl_exceeded,
                     "frr_bfd:echo_packet_error":
                     parse_frr_bfd_echo_packet_error,
                     "frr_bfd:echo_mode_change":
                     parse_frr_bfd_echo_mode_change,
                     "frr_bfd:control_client_event":
                     parse_frr_bfd_control_client_event,
                     "frr_bfd:dplane_session_update":
                     parse_frr_bfd_dplane_session_update,
                     "frr_bfd:dplane_echo":
                     parse_frr_bfd_dplane_echo,
                     "frr_bfd:vrf_lifecycle":
                     parse_frr_bfd_vrf_lifecycle,
                     "frr_bfd:zebra_interface_event":
                     parse_frr_bfd_zebra_interface_event,
                     "frr_bfd:zebra_address_event":
                     parse_frr_bfd_zebra_address_event,
                     "frr_bfd:control_protocol_error":
                     parse_frr_bfd_control_protocol_error,
                     "frr_bfd:ptm_session_event":
                     parse_frr_bfd_ptm_session_event,
                     "frr_bfd:ptm_client_event":
                     parse_frr_bfd_ptm_client_event,
                     "frr_bfd:ptm_error":
                     parse_frr_bfd_ptm_error,
                     "frr_bfd:ptm_config_refcount_error":
                     parse_frr_bfd_ptm_config_refcount_error,
                     "frr_bfd:packet_send_error":
                     parse_frr_bfd_packet_send_error,
                     "frr_bfd:stats_error":
                     parse_frr_bfd_stats_error,
