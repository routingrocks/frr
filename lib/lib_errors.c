...
static struct log_ref ferr_lib_err[] = {
	...
	},
	{
		...
		.description = "Upon startup FRR failed to properly initialize and startup the ConfD "
		"northbound plugin",
		.suggestion = "Check if ConfD is installed correctly in the system. Also, check if the confd "
		"daemon is running.",
	},
	{
	...
	},
	{
		...
		.description = "The northbound subsystem has detected that the libconfd library returned an "
		"error",
		.suggestion = "Open an Issue with all relevant log files and restart FRR",
	},
	{
